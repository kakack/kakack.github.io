...
$$2 \times 32层 \times 32头 \times 128维 \times 2 bytes=0.5 MB$$
...
$$搬运时间=\frac{15.5\text{ GB}}{768\text{ GB/s}} \approx 20.2\text{ ms}\\计算时间 \approx \frac{14  \text{ GFLOPS}}{155000  \text{ GFLOPS}} \approx 0.09 \text{ ms}$$

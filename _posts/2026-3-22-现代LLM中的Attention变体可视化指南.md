...
![图 4：即使很多词汇选择看起来合理，翻译也可能因为句子级结构而失败](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-02.webp)

![图 5：Attention 通过让当前输出位置回查完整输入序列，打破了 RNN 的瓶颈](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-03.webp)
...
![图 6：一个具体的 masked attention matrix，每一行属于一个 token，每个元素是注意力权重，未来 token 的位置被因果 mask 移除](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-04.webp)
...
![图 12：105B Sarvam（使用 MLA）、30B Sarvam（使用 GQA）与普通 MHA 的 KV cache 大小对比](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-10.webp)
...
![图 13：与 GQA 不同，MLA 不通过分组 head 来降低 KV 成本，而是通过缓存压缩后的 latent 表示来实现](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-11.webp)
...
![图 16：GQA 和 MLA 从不同方向解决同一个瓶颈，权衡点在于实现简洁性与大模型建模性能之间](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-14.webp)
...
![Gemma ablation 研究表明，更小的窗口和更激进的 local:global 比例对 perplexity 影响很小（数据来自 Gemma 3 论文）](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-16.webp)
...
![图 18：长 context 的节省来自于将很多 full-attention 层变为 local 层，从而减少这些层需要考虑的缓存 context 量](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-17.webp)
...
![图 19：与 SWA 类似，DeepSeek Sparse Attention 也将每个 token 的 attention 限制在前序 token 的子集，但不使用固定局部窗口](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-18.webp)
...
![图 20：DeepSeek V3.2 是最直接的参考点，这个模型家族与 sparse attention 想法联系最为紧密](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-19.webp)
...
![图 22：Trinity Large 中 gate 出现在 scaled dot-product attention 输出之后、output projection 之前，说明 gated attention 不仅是 Qwen 的想法](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-21.webp)
...
![图 23：在 Qwen3-Next 和 Qwen3.5 中，gated attention 作为周期性打断连续 Gated DeltaNet block 的 full-attention 层出现](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-22.webp)
...
![图 24：基础 hybrid 模式：大多数 block 是更便宜的 sequence mixer，每第四个 block 恢复一个较重的 attention 层](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-23.webp)
...
![图 27：Kimi Linear 保留了相同的整体 hybrid 模式，同时改变了轻量侧和较重 attention 侧的具体组件](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-26.webp)
...
![图 30：Nemotron 3 Nano 将 Mamba-2 用于大多数序列建模工作，self-attention 只出现在少数层](https://raw.githubusercontent.com/kakack/kakack.github.io/master/_images/260322-attn-29.webp)
